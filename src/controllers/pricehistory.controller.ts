...
const batchInfo = {
    functionId: 'BTRI4306',
    moduleId: 'BTRI4',
    functionName: 'PSMR Price History Report'
}
...
const generateExcel = async (req: Request, res: Response, next: NextFunction) => {
    ...
    req.body.query["DETAIL_PRICE_CAT"] = `1`; //Fixed for this eport
    ...
    return handlers.createExcelStream({
        ...
        formatFilename: ()=>{
            return `PriceHistoryReport_${dayjs().format('YYYYMMDDHHmmss')}.xlsx`
        },
